...
public class DocumentBuilder extends AbstractDocumentBuilder {
    ...
    public AbstractDocument build(int docId, String docPath, File file) {
        ...
        try {
            ...
            tuplestream = new StopWordTermTupleFilter(new LengthTermTupleFilter(new PatternTermTupleFilter(new TermTupleScanner(reader))));
        } catch (FileNotFoundException e) {
            e.printStackTrace();
        }
        return this.build(docId, docPath, tuplestream);
    }
}
